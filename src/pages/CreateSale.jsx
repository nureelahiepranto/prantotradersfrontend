...
//       return prod ? total + Number(prod.sellPrice || 0) * Number(it.qty || 0) : total;
//     }, 0);
//   };
...
//   if (!items.length) return alert("Add at least 1 product");
...
//     if (saleId) navigate(`/invoice/${saleId}`);
//     else navigate("/dsr/sales");
...
//                     Price: {Number(p.sellPrice).toFixed(2)} ৳
//                   </div>
//                 </div>
//                 <button
...
//           <h3 className="font-semibold mb-3">Sale Form</h3>
...
//               {items.map((it, idx) => {
//                 const p = products.find((pp) => pp._id === it.productId) || {};
//                 return (
//                   <div key={idx} className="mb-2 flex items-center gap-2 border p-2 rounded">
//                     <div className="flex-1">
//                       <div className="text-sm font-medium">{p.name || "Product"}</div>
//                       <div className="text-xs text-gray-500">
//                         Unit: {p.sellPrice ? Number(p.sellPrice).toFixed(2) : "-"} ৳
//                       </div>
//                     </div>
//                     <input
//                       type="number"
...
//                       {p.sellPrice ? (Number(p.sellPrice) * it.qty).toFixed(2) : "0.00"} ৳
//                     </div>
//                     <button
//                       type="button"
//                       className="px-2 py-1 border rounded"
